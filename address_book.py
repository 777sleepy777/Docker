...
class AddressBook(UserDict):
        ...
        for value in self.data.values():
            if value.birthday:
                if int(self.days_to_birthday(value.birthday)) == int(days):
                    ...
                    print(
                        f'{value.name}, Date of Birth: {value.birthday.strftime("%d/%m/%Y")}'
                    )
    ...
    def days_to_birthday(self, bday):
        ...
        date_of_future_birthday = date(
            year=year_of_future_birthday, month=bday.month, day=bday.day
        )
    ...
    def load(self):
        while True:
            ...
            try:
                ...
                print(
                    "File not found, try enter another file or check name entered file"
                )
